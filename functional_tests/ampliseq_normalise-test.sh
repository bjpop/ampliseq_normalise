...
this_program_name="ampliseq_normalise-test.sh"
...
${this_program_name}: run integration/regression tests for ampliseq_normalise 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/ampliseq_normalise -d data/tests
