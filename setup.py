...
setup(
    name='ampliseq_normalise',
    version='0.1.0.0',
    author='Bernie Pope',
    author_email='bjpope@unimelb.edu.au',
    packages=['ampliseq_normalise'],
    package_dir={'ampliseq_normalise': 'ampliseq_normalise'},
    entry_points={
        'console_scripts': ['ampliseq_normalise = ampliseq_normalise.ampliseq_normalise:main']
    },
    url='https://github.com/bjpop/ampliseq_normalise',
    license='LICENSE',
